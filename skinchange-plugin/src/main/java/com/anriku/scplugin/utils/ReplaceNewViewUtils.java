...
public class ReplaceNewViewUtils {
    ...
    public static final String SC_APP_COMPAT_PACKAGE = "com/anriku/sclib/widget/";
    public static final String ANDROID_WIDGET = "android/widget/";
    public static final String COMPATIBLE_WIDGET = PackageNameUtils.sViewPackageName.replace(".", "/") + "/";

    // 需要被替换的类和代理类的映射
    public static HashMap<String, String> sNeedReplaceViews = new HashMap<>();

    static {
        sNeedReplaceViews.put(ANDROID_WIDGET + "View", SC_APP_COMPAT_PACKAGE + "SCView");
