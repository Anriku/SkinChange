 ...
 */
public class SCAppCompatImageButtonDump {
    ...
    public static byte[] dump() {
        ...
        cw.visit(Opcodes.V1_7, Opcodes.ACC_PUBLIC + Opcodes.ACC_SUPER, "com/anriku/sclib/widget/SCAppCompatImageButton", null, VIEW_PACKAGE_NAME + "AppCompatImageButton", new String[]{"com/anriku/sclib/widget/SkinChange"});

        cw.visitSource("SCAppCompatImageButton.java", null);
        ...
        }
        {
            ...
            Label l2 = new Label();
            mv.visitLabel(l2);
            mv.visitLocalVariable("this", "Lcom/anriku/sclib/widget/SCAppCompatImageButton;", null, l0, l2, 0);
        ...
        }
        {
            ...
            mv.visitLdcInsn(new Integer(16842866));
            mv.visitMethodInsn(Opcodes.INVOKESPECIAL, "com/anriku/sclib/widget/SCAppCompatImageButton", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", false);
            Label l1 = new Label();
            mv.visitLabel(l1);
        ...
        }
        {
            ...
            mv.visitMethodInsn(Opcodes.INVOKESPECIAL, VIEW_PACKAGE_NAME + "AppCompatImageButton", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", false);
            Label l1 = new Label();
            mv.visitLabel(l1);
            ...
            mv.visitFieldInsn(Opcodes.PUTFIELD, "com/anriku/sclib/widget/SCAppCompatImageButton", "mSCImageHelper", "Lcom/anriku/sclib/helpers/SCImageHelper;");
            Label l2 = new Label();
            mv.visitLabel(l2);
            ...
            mv.visitFieldInsn(Opcodes.PUTFIELD, "com/anriku/sclib/widget/SCAppCompatImageButton", "mSCBackgroundHelper", "Lcom/anriku/sclib/helpers/SCBackgroundHelper;");
            Label l3 = new Label();
            mv.visitLabel(l3);
            mv.visitLineNumber(34, l3);
            mv.visitVarInsn(Opcodes.ALOAD, 0);
            mv.visitFieldInsn(Opcodes.GETFIELD, "com/anriku/sclib/widget/SCAppCompatImageButton", "mSCImageHelper", "Lcom/anriku/sclib/helpers/SCImageHelper;");
            mv.visitVarInsn(Opcodes.ALOAD, 2);
            mv.visitVarInsn(Opcodes.ILOAD, 3);
            ...
            mv.visitVarInsn(Opcodes.ALOAD, 0);
            mv.visitFieldInsn(Opcodes.GETFIELD, "com/anriku/sclib/widget/SCAppCompatImageButton", "mSCBackgroundHelper", "Lcom/anriku/sclib/helpers/SCBackgroundHelper;");
            mv.visitVarInsn(Opcodes.ALOAD, 2);
            mv.visitVarInsn(Opcodes.ILOAD, 3);
            ...
            Label l6 = new Label();
            mv.visitLabel(l6);
            mv.visitLocalVariable("this", "Lcom/anriku/sclib/widget/SCAppCompatImageButton;", null, l0, l6, 0);
        ...
        }
        {
            ...
            mv.visitVarInsn(Opcodes.ALOAD, 0);
            mv.visitVarInsn(Opcodes.ILOAD, 1);
            mv.visitMethodInsn(Opcodes.INVOKESPECIAL, VIEW_PACKAGE_NAME + "AppCompatImageButton", "setBackgroundResource", "(I)V", false);
            Label l4 = new Label();
            mv.visitLabel(l4);
            ...
            Label l5 = new Label();
            mv.visitLabel(l5);
            mv.visitLocalVariable("this", "Lcom/anriku/sclib/widget/SCAppCompatImageButton;", null, l0, l5, 0);
        ...
        }
        {
            ...
            mv.visitVarInsn(Opcodes.ALOAD, 0);
            mv.visitVarInsn(Opcodes.ILOAD, 1);
            mv.visitMethodInsn(Opcodes.INVOKESPECIAL, VIEW_PACKAGE_NAME + "AppCompatImageButton", "setImageResource", "(I)V", false);
            Label l4 = new Label();
            mv.visitLabel(l4);
        ...
        }
        {
            ...
            Label l3 = new Label();
            mv.visitLabel(l3);
            mv.visitLocalVariable("this", "Lcom/anriku/sclib/widget/SCAppCompatImageButton;", null, l0, l3, 0);
            mv.visitMaxs(1, 1);
            mv.visitEnd();
        }
        cw.visitEnd();
