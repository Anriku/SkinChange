...
public class SCCompatMultiAutoCompleteTextView extends AppCompatMultiAutoCompleteTextView implements SkinChange {
    ...
    public SCCompatMultiAutoCompleteTextView(Context context) {
        this(context, null);
    }

    public SCCompatMultiAutoCompleteTextView(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.autoCompleteTextViewStyle);
    }

    public SCCompatMultiAutoCompleteTextView(Context context, AttributeSet attrs, int defStyleAttr) {
